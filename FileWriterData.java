...
public class FileWriterData{
  ...
  public static void init_arff(byte[][] envi){
    try{
      ...
      fich.write("@ATTRIBUTE isObstaculeNear {true,false} \n");
      fich.write("@ATTRIBUTE ticks_count NUMERIC \n");
      ...
      fich.write("@ATTRIBUTE JUMP_RIGHT {Jump,Do_Not_Jump} \n");
  ...
  public static void writeOnFile(float[] posMario, int[] dataMatrix, byte[][] envi, String action, int counttick, int[] marioState, int tick){
    ...
    // Predicción del incremento de la recompensa en 24 ticks
  ...
  if( !ruleTriggered ){
    ...
    if(envi[9][10] == 80 || envi[9][11] == 80 ||
      ...
      isEnemy = true;
      //System.out.println("is enemy true");
      instancia[mz] = String.valueOf(isEnemy);
    }
    else{
      isEnemy = false;
      //System.out.println("is enemy false");
      instancia[mz] = String.valueOf(isEnemy);
    }
    mz++;
    ...
    if(envi[9][10] == -24 || envi[9][11] == -24 || envi[8][10] == -24 || envi[8][11] == -24 ||
      ...
      isBlock = true;
      //System.out.println("is block true");
      instancia[mz] = String.valueOf(isBlock);
    }
    else{
      isBlock = false;
      //System.out.println("is block false");
      instancia[mz] = String.valueOf(isBlock);
    }
    mz++;

    instancia[mz] = String.valueOf(counttick);
    mz++;
    ...
    */
    future[tick][0] = instancia[382];
    future[tick][1] = instancia[371];
    ...
    if(tick > 24){
      ...
      */
      ...
      try {
          ...
          String[] instanciaCompleta = new String[instanciaActual.length+6];
